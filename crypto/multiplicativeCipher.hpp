#ifndef NETSEC_MULTIPLICATIVE_CIPHER_HPP_INCLUDED__
#define NETSEC_MULTIPLICATIVE_CIPHER_HPP_INCLUDED__
...
namespace gnsp{ namespace NetSec {
	...
	namespace crypto{
		...
		class multiplicativeCipher{
			public:
				multiplicativeCipher():	key_(1){}
				multiplicativeCipher(T key){
					if(key%2 == 0 || key == 13) key_ = 1;
					else key_ = key;
				}
